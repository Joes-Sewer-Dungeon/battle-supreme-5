		...
		if ( m_pClassImage )
		{
			...
			if ( ( m_iPrevClass != iClass ) || bChanged )
			{
				...
				else if ( iClass == TF_CLASS_UNDEFINED )
				{
					...
					{
						m_pClassImage->SetImage( VarArgs( "%s_alpha", ( m_iTeam == TF_TEAM_RED ) ? g_pszItemClassImagesRed[iDeadClass + TF_LAST_NORMAL_CLASS] : g_pszItemClassImagesBlue[iDeadClass + TF_LAST_NORMAL_CLASS] ) );
					}
					else
					{
				...
				else
				{
					...
					{
						m_pClassImage->SetImage( VarArgs( "%s_alpha", ( m_iTeam == TF_TEAM_RED ) ? g_pszItemClassImagesRed[iClass + TF_LAST_NORMAL_CLASS] : g_pszItemClassImagesBlue[iClass + TF_LAST_NORMAL_CLASS] ) );
